...
var length = require('../build/list/length');
var range = require('../build/list/range');
var map = require('../build/list/map');
var reduce = require('../build/list/reduce');
var filter = require('../build/list/filter');
var filter = require('../build/list/filter');
var peek = require('../build/list/peek');
var push = require('../build/list/push');
var pop = require('../build/list/pop');
var zip = require('../build/list/zip');
var some = require('../build/list/some');
var every = require('../build/list/every');
var reverse = require('../build/list/reverse');
var slice = require('../build/list/slice');
var concat = require('../build/list/concat');
var enqueue = require('../build/list/enqueue');
var dequeue = require('../build/list/dequeue');
var sort = require('../build/list/sort');
var contains = require('../build/list/contains');
